...
function generarBotonesDeHojas() {
  return _generarBotonesDeHojas.apply(this, arguments);
}
function _generarBotonesDeHojas() {
  _generarBotonesDeHojas = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        case 0:
          ...
          return Excel.run(/*#__PURE__*/function () {
            var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(context) {
              var sheets, hojaActiva, activeSheetName, container, hojasVisibles;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    sheets = context.workbook.worksheets;
                    sheets.load("items/name,items/visibility");
                    hojaActiva = context.workbook.worksheets.getActiveWorksheet();
                    hojaActiva.load("name");
                    _context3.next = 6;
                    return context.sync();
                  case 6:
                    activeSheetName = hojaActiva.name;
                    container = document.getElementById("buttonsContainer");
                    container.innerHTML = "";
                    hojasVisibles = sheets.items.filter(function (sheet) {
                    ...
                    hojasVisibles.forEach(function (sheet) {
